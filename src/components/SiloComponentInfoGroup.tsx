      ...
      {components.map((component) => (
        ...
        >
          ...
          <div className="text-sm mt-2">
            <p>
              Estado:{" "}
              {component.type === "transferidor" && ctData
                ? ctData.ct_defecto === 1
                  ? "Error"
                  : ctData.ct_automatico === 1
                    ? "Automático"
                    : ctData.ct_semiautomatico === 1
                      ? "Semi-Auto"
                      : ctData.ct_manual === 1
                        ? "Manual"
                  ...
                  <div className="mt-3">
                    <div className="flex flex-col gap-2">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-bold text-gray-700">
                          Pasillo {ptData ? ptData.pt_posicion : component.position.y}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-base font-bold text-gray-700">
                          {ptData ? (ptData.pt_ocupacion === 1 ? 'Ocupado' : 'Libre') : '-'}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-operator-blue">Estado:</span>
                        <span className="text-base font-bold text-gray-700">
                          {ptData ? (ptData.pt_estado === 1 ? 'Error' : 'Normal') : '-'}
                        </span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-operator-blue">Situación:</span>
                        <span className="text-base font-bold text-gray-700">
                          {ptData ? ptData.pt_situacion : '-'}
                        </span>
                      </div>
                    </div>
                  </div>
